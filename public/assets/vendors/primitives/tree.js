    ...
    if (target.hasClass("btn") || target.parent(".btn").length > 0) {
        ...
        switch(buttonname) {
            case 'add':
            	...
            	message = '<div class="radio"><label>xxxxxxxxx<input type="radio" name="optionsRadios" id="optionsRadios1" value="1" checked>Add a parent</label></div><div class="radio"><label><input type="radio" name="optionsRadios" id="optionsRadios2" value="2">Add a spouse</label></div><div class="radio"><label><input type="radio" name="optionsRadios" id="optionsRadios3" value="3">Add a child</label></div>';
