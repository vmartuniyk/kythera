...
<html lang="en-US">
    ...
    <body>
        ...
        <hr class="black"/>
        <p class="content">Dear {!!$invitee_name!!},</p>
        <p class="content">
        You have been invited by {!!$inviter_name!!} to collaborate on Family Tree entry "{!!$title!!}".
        <br/>
        <br/>
        Please click <a href="{!!$edit!!}">here</a> to start.<br/><br/>
        Regards,<br/>
        KFN Team
        </p>
        <hr class="black"/>
