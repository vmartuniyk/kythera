						...
						<div class="content-inner__wrap">
							<section class="profile-content">
								<div class="profile-content__top profile-top">
									<h1 class="profile-top__title">Welcome to Your Comments</h1>
										...
										@if($list == 'comment')
											...
											<li class="activity__item item-activity">
												<div class="item-activity__info">
													<a href="{!!Router::getItemUrl($entries[$i])!!}" class="item-activity__link">
													...
													<div class="item-activity__wrap">
														<h5 class="item-activity__title">{{$entries[$i]->title}}</h5>
