...
<head>
    ...
    {!! xhtml::style('assets/css/main.css?cb='.time()) !!}
...
{{--									<span class="actions-header__user-login"></span>--}}
									...
									<span class="actions-header__user-name">{{ Auth::user()->firstname  }}</span>
...
{{--							<ul class="actions-header__socials social-links">--}}
{{--								<li class="social-links__item">--}}
{{--									<!--noindex-->--}}
{{--									<a href="#" class="social-links__link" rel="nofollow noopener noreferrer" target="_blank">--}}
{{--										<svg id="Twitter" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="19.726" height="16" viewBox="0 0 19.726 16">--}}
...
{{--									<!--noindex-->--}}
{{--									<a href="#" class="social-links__link" rel="nofollow noopener noreferrer" target="_blank">--}}
{{--										<svg id="Facebook" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="8.356" height="16" viewBox="0 0 8.356 16">--}}
		...
		<div class="hystmodal__wrap">
			<div class="hystmodal__window" role="dialog" aria-modal="true">
				<div class="log-menu">
					...
					<form action="{{ action('UsersController@postLogin') }}" method="POST" class="log-menu__form">
						{!! csrf_field() !!}
		...
		<div class="hystmodal__wrap">
			<div class="hystmodal__window" role="dialog" aria-modal="true">
				<div class="log-menu">
					...
					<form id="register" method="POST" action="{{ action('UsersController@postRegister') }}" accept-charset="UTF-8" class="log-menu__form">
						{!! csrf_field() !!}
						<div class="log-menu__input">
							<input class="form-control required" placeholder="First name" type="text" name="firstname" id="firstname" value="{{ Input::old('firstname') }}">

{{--							<input type="text" placeholder="Enter Username Sign Up">--}}
						</div>
						<div class="log-menu__input">
							<input class="form-control required" placeholder="Last name" type="text" name="lastname" id="lastname" value="{{ Input::old('lastname') }}">
						</div>
						<div class="log-menu__input">
