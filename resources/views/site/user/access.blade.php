			...
			<div class="row">
				...
				<div class="col-md-6 ">
					<div class="panel panel-default">
						...
						<div class="panel-heading" style="margin-bottom: 10px;">Register</div>
						<div class="panel-body" style="max-width: 300px;margin: 0 auto;margin-bottom: 10px;">
							@if (session('status'))
								<div class="alert alert-success" style="color: white;padding: 10px;">
									{{ session('status') }}
							...
							<form action="{{ action('UsersController@postRegister') }}" method="POST" class="log-menu__form" style="max-width: 300px;margin: 0 auto">
								{!! csrf_field() !!}
{{--								<div class="form-group">--}}
									{{--		                <label for="firstname">Firstname</label>--}}
									{{--		                <input class="form-control required" placeholder="Firstname" type="text" name="firstname" id="firstname" value="{{ Input::old('firstname') }}">--}}
								...
								<div class="log-menu__input">
									<input placeholder="Firstname" type="text" name="firstname" id="firstname" value="{{ Input::old('firstname') }}">
								</div>
