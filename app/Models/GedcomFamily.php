...
class GedcomFamily extends Model
{
     ...
     * @var string
     */
    protected $table = 'gedcom_families';
     ...
     * @var array
     */
    protected $appends = ['husb_key', 'wife_key', 'children_keys'];
    ...
    {
        return $this->belongsTo('App\Models\GedcomIndividual', 'indi_id_husb');
    }
    ...
    {
        return $this->belongsTo('App\Models\GedcomIndividual', 'indi_id_wife');
    }
    ...
    {
        return $this->hasMany('App\Models\GedcomEvent', 'fami_id');
    }
    ...
    {
        return $this->hasMany('App\Models\GedcomNote', 'fami_id');
    }
    ...
    {
        return $this->hasManyThrough('App\Models\GedcomNote', 'App\Models\GedcomEvent', 'fami_id', 'even_id');
    }
    ...
    {
        return $this->hasMany('App\Models\GedcomSource', 'fami_id');
    }
    ...
    {
        return $this->hasManyThrough('App\Models\GedcomSource', 'App\Models\GedcomEvent', 'fami_id', 'even_id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\GedcomIndividual', 'gedcom_children', 'fami_id', 'indi_id');
    }
    ...
    public function getChildrenKeysAttribute()
    {
        ...
        foreach ($this->children->lists('gedcom_key') as $child) {
            array_push($result, ['gedcom_key' => $child]);
        }
        return $result;
    }
