...
class WT_Date_Calendar
{
    ...
    protected function FormatLongMonth($case = 'NOMINATIVE')
    {
        switch ($case) {
            case 'GENITIVE':
                return $this->NUM_TO_MONTH_GENITIVE($this->m, $this->IsLeapYear());
            case 'NOMINATIVE':
                return $this->NUM_TO_MONTH_NOMINATIVE($this->m, $this->IsLeapYear());
            case 'LOCATIVE':
                return $this->NUM_TO_MONTH_LOCATIVE($this->m, $this->IsLeapYear());
            case 'INSTRUMENTAL':
                return $this->NUM_TO_MONTH_INSTRUMENTAL($this->m, $this->IsLeapYear());
        }
    }
