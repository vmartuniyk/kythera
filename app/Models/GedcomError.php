...
class GedcomError extends Model
{
     ...
     * @var string
     */
    protected $table = 'gedcom_errors';

    /**
     * Returns the Gedcom to which this GedcomError belongs.
     * @return Gedcom
     */
    ...
    /**
     * Returns the GedcomIndividual to which this GedcomError belongs.
    ...
    /**
     * Returns the GedcomFamily to which this GedcomError belongs.
     * @return GedcomFamily
     */
