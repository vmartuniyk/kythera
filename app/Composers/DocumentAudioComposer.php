 ...
 *
 */
class DocumentAudioComposer extends PageComposer
{
    ...
    public function compose($view)
    {
        ...
        switch ($view->getName()) {
            case 'site.document.audio.index':
                ...
                $pages = DocumentAudio::select('document_entities.*', 'users.firstname', 'users.middlename', 'users.lastname')
