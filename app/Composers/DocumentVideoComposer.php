 ...
 *
 */
class DocumentVideoComposer extends PageComposer
{
    ...
    public function compose($view)
    {
        ...
        switch ($view->getName()) {
            case 'site.document.video.index':
                ...
                $pages = DocumentVideo::select('document_entities.*', 'users.firstname', 'users.middlename', 'users.lastname')
