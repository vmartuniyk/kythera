...
class FileUploadsController extends Controller
{
    ...
    public function postUpload()
    {
        foreach (Input::file('uploads') as $file) {
            ...
            if ($validator->passes()) {
                ...
                return redirect('gedcoms/upload')->withErrors($validator)->withInput();
            }
        }

        return redirect('gedcoms/index')->with('message', 'The file(s) were uploaded. '
     ...
     * @param string $file
     */
    protected function chunkFile($file)
    {
        $file_data = '';
        $fp = fopen($file, 'rb');
        $i = 1;
