...
use Kythera\Support\ViewDocumentVideo;
 ...
 *
 */
class DocumentVideoController extends PageController
{
    ...
    {
        if ($item = DocumentVideo::select('document_entities.*', 'users.firstname', 'users.middlename', 'users.lastname', 'users.id as user_id')
                ->withUser()
    ...
    {
        Log::info('DocumentVideoController->missingMethod', $parameters);
    }
}
