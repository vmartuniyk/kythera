...
//fixme: move to intervention

class DocumentImageController extends PageController
{
    ...
    {
        Log::info('DocumentImageController->missingMethod: ' . print_r($parameters, 1));
    }
}
