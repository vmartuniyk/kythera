<?php /* <hr class="line gray clear toolbar">

<?php if($item = Session::get('selected.item', null)): ?>
    <div class="toolbar-view">
        <?php echo xmenu::entry_edit($item->user_id, $item); ?>

    </div>
<?php else: ?>
    <div class="toolbar-view">
        <?php echo xmenu::entry_edit(null, null); ?>

    </div>
<?php endif; ?>

<!-- sidebar/posts -->
<?php echo $__env->make('site.document.text.blocks.sidebar.posts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- /sidebar/posts -->

<!-- sidebar/media -->
<?php echo $__env->make('site.document.text.blocks.sidebar.media', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- /sidebar/media -->

<!-- sidebar/tourist -->
<?php echo $__env->make('site.document.text.blocks.sidebar.tourist', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- /sidebar/tourist -->

<!-- sidebar/board -->
<?php echo $__env->make('site.document.text.blocks.sidebar.message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- /sidebar/board --> */ ?>
