...
<head>
    ...
    <?php echo xhtml::style('assets/css/main.css?cb='.time()); ?>
				...
				<div class="header__container">
					<div class="header__wrap">
						...
						<div class="header__actions actions-header">
							...
							<?php if(Auth::check()): ?>
							<a href="/en/your-personal-page" class="actions-header__login">
								<span class="actions-header__user-icon">
<?php /*									<span class="actions-header__user-login"></span>*/ ?>
									...
									<span class="actions-header__user-name"><?php echo e(Auth::user()->firstname); ?></span>

							</a>
							<?php else: ?>
								<a href="#" class="actions-header__login" data-popup="#login-popup">
									<span class="actions-header__user-icon">
	<?php /*									<span class="actions-header__user-login"></span>*/ ?>
										<span class="actions-header__user-logout"></span>
										<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
									...
									<span class="actions-header__user-name">Log In</span>
								</a>
							<?php endif; ?>
							<a href="#" class="actions-header__login" data-popup="#sign-up-popup">
								<span class="actions-header__user-name">Sign Up</span>
							</a>

<?php /*							<ul class="actions-header__socials social-links">*/ ?>
<?php /*								<li class="social-links__item">*/ ?>
<?php /*									<!--noindex-->*/ ?>
<?php /*									<a href="#" class="social-links__link" rel="nofollow noopener noreferrer" target="_blank">*/ ?>
<?php /*										<svg id="Twitter" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="19.726" height="16" viewBox="0 0 19.726 16">*/ ?>
<?php /*											<path id="Path_2" data-name="Path 2" d="M44.247,18A11.4,11.4,0,0,0,55.753,6.493V5.945a8.908,8.908,0,0,0,1.973-2.082,9.1,9.1,0,0,1-2.3.658,4.264,4.264,0,0,0,1.753-2.192,10.052,10.052,0,0,1-2.521.986A3.914,3.914,0,0,0,51.7,2a4.117,4.117,0,0,0-4.055,4.055,2.136,2.136,0,0,0,.11.877,11.33,11.33,0,0,1-8.329-4.274,4.2,4.2,0,0,0-.548,2.082,4.354,4.354,0,0,0,1.753,3.4,3.694,3.694,0,0,1-1.863-.548h0a4.005,4.005,0,0,0,3.288,3.945,3.378,3.378,0,0,1-1.1.11,1.865,1.865,0,0,1-.767-.11,4.152,4.152,0,0,0,3.836,2.849,8.274,8.274,0,0,1-5.041,1.753,3.034,3.034,0,0,1-.986-.11A10.344,10.344,0,0,0,44.247,18" transform="translate(-38 -2)" fill-rule="evenodd" />*/ ?>
<?php /*										</svg>*/ ?>
<?php /*									</a>*/ ?>
<?php /*									<!--/noindex-->*/ ?>
<?php /*								</li>*/ ?>
...
<?php /*									<!--noindex-->*/ ?>
<?php /*									<a href="#" class="social-links__link" rel="nofollow noopener noreferrer" target="_blank">*/ ?>
<?php /*										<svg id="Facebook" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="8.356" height="16" viewBox="0 0 8.356 16">*/ ?>
<?php /*											<path id="Path_1" data-name="Path 1" d="M85.422,16V8.711h2.489l.356-2.844H85.422V4.089c0-.8.267-1.422,1.422-1.422h1.511V.089C88,.089,87.111,0,86.133,0a3.431,3.431,0,0,0-3.644,3.733V5.867H80V8.711h2.489V16Z" transform="translate(-80)" fill-rule="evenodd" />*/ ?>
<?php /*										</svg>*/ ?>
<?php /*									</a>*/ ?>
<?php /*									<!--/noindex-->*/ ?>
<?php /*								</li>*/ ?>
				...
				<nav class="header__menu header-nav">
					...
					<div class="header-nav__accordion nav-accordion" data-spollers data-one-spoller>
						<div class="nav-accordion__item">
							<button type="button" class="nav-accordion__button _spoller-active" data-spoller>
								<span>Discover</span>
							...
							<ul class="nav-accordion__list">
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Kytherian People</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Family Trees</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Villages</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Island History</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Greek Mythology</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Culture</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Arts & Music</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Academic Research</a>
								</li>
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Photos & Videos</a>
								</li>
							</ul>
						</div>
						<div class="nav-accordion__item">
						...
						<div class="nav-accordion__item">
							...
							<ul class="nav-accordion__list">
								<li class="nav-accordion__item-list">
									<a href="#" class="nav-accordion__link">Ms. Aphrodite</a>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="footer__container">
				<div class="footer__wrap">
					<div class="footer__item">
						...
						<p class="footer__text">Sign up to receive our monthly newsletters, island updates and travel offers.</p>
						<div class="footer__enter-field">
					...
					<div class="footer__item">
						...
						<a href="tel:12345678910" class="footer__phone">123-456-78910</a>
			...
			<div class="hystmodal__window" role="dialog" aria-modal="true">
				<div class="log-menu">
					...
					<div class="log-menu__logo">
						<img src="<?php echo e(URL::asset('assets/img/icons/log-menu-logo.svg')); ?>" alt="">
					</div>
					<form action="<?php echo e(action('UsersController@postLogin')); ?>" method="POST" class="log-menu__form">
						<?php echo csrf_field(); ?>

						<div class="log-menu__input">
							<input type="text" placeholder="Enter Username" name="email" id="email" value="<?php echo e(old('email')); ?>">
						</div>
						<div class="log-menu__input">
		...
		<div class="hystmodal__wrap">
			<div class="hystmodal__window" role="dialog" aria-modal="true">
				<div class="log-menu">
					...
					<form id="register" method="POST" action="<?php echo e(action('UsersController@postRegister')); ?>" accept-charset="UTF-8" class="log-menu__form">
						<?php echo csrf_field(); ?>

						<div class="log-menu__input">
							<input class="form-control required" placeholder="First name" type="text" name="firstname" id="firstname" value="<?php echo e(Input::old('firstname')); ?>">

<?php /*							<input type="text" placeholder="Enter Username Sign Up">*/ ?>
						</div>
						<div class="log-menu__input">
							<input class="form-control required" placeholder="Last name" type="text" name="lastname" id="lastname" value="<?php echo e(Input::old('lastname')); ?>">
						</div>
						<div class="log-menu__input">
							<input class="form-control required" placeholder='example@gmail.com' type="email" name="email" id="email" value="<?php echo e(Input::old('email')); ?>">
						</div>
