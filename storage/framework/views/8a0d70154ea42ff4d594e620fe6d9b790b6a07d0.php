<aside class="inner-page__aside aside" id="aside">
    <nav class="aside__nav" id="aside-nav" data-spollers data-one-spoller>
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'people') ? '_spoller-active' : ''); ?>" data-spoller>
        ...
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'gravestones') ? '_spoller-active' : ''); ?>" data-spoller>
        ...
        <div class="aside__item">
            <a class="aside__title aside_single <?php echo e((request()->segment(2) == 'villages-towns') ? 'current' : ''); ?> " href="/en/villages-towns">
                <span>Villages</span>
            </a>
        </div>
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'history') ? '_spoller-active' : ''); ?>" data-spoller>
        ...
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'culture') ? '_spoller-active' : ''); ?>" data-spoller>
                <span>Culture</span>
                <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" width="17.386" height="9.799" viewBox="0 0 17.386 9.799">
                    <path data-name="Path 212" d="M888,80l-8,7.691L872,80" transform="translate(-871.307 -79.279)" fill="none" stroke-miterlimit="10" stroke-width="2" />
                </svg>
        ...
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'natural-history-museum') ? '_spoller-active' : ''); ?> " data-spoller>
        ...
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'academic-research') ? '_spoller-active' : ''); ?>" data-spoller>
        ...
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e((request()->segment(2) == 'tourist-information') ? '_spoller-active' : ''); ?>" data-spoller>
        ...
        <div class="aside__item">
            <button type="button" class="aside__title <?php echo e(in_array(request()->segment(2),['photos','audiovideo'])  ? '_spoller-active' : ''); ?>" data-spoller>
            ...
            <ul class="aside__list">
                ...
                <li class="aside__list-item" >
                    <a href="/en/audiovideo/vintage-films" class="aside__link <?php echo e((request()->segment(3) == 'vintage-films') ? 'aside__title current' : ''); ?>">Vintage Films</a>
                </li>

            </ul>
        </div>
        <div class="aside__item">
            <a class="aside__title aside_single <?php echo e((request()->segment(2) == 'message-board') ? 'current' : ''); ?>" href="/en/message-board">
                <span>Message Board</span>
            </a>
        </div>

        <div class="aside__item">
            <a class="aside__title aside_single <?php echo e((request()->segment(2) == 'newsletter-archive') ? 'current' : ''); ?>" href="/en/newsletter-archive">
